.PHONY: all build check test lint fmt clippy doc clean ci help \
       mdbook mdbook-serve mdbook-clean mdbook-test doc-all doc-serve clean-all quick watch bench audit update outdated
...
doc-serve: doc mdbook
	...
	@echo "  - API:   docs/book/api/fugue_causal/index.html"
	mdbook serve docs --open
...
ci: fmt clippy check test test-doc doc mdbook
